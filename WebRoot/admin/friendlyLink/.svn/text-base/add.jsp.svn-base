 	  ...
 	  <form id="friendlyLink_addForm" method="post">
 	     <table class="tableForm" style="margin-left: 10px;margin-top: 15px">
			  ...
			  <td><input name="orderlist" class="easyui-numberspinner"
						data-options="min:0,max:999,editable:false,required:true,missingMessage:'请选择菜单排序'" value="${friendlyLink.orderlist}" size="43" />
			  </td>
 	     	</tr>
 	     	...
 	     	<tr >
				...
				<div >
					<span id="button"
						style="padding-left: 5px;padding-top: 5px;float: left;"><a class="easyui-linkbutton"
						href="javascript:makerUploadForAdd(false)">选择图片</a>
					</span>
					<span id="admin_upload_add_thumbPic" style="padding-left: 5px;float: right;padding-bottom: 10px;" ></span>	
				</div>
 	     	  </td>
 	     	</tr>
 	     </table>
