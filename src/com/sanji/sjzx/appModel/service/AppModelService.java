package com.sanji.sjzx.appModel.service;
...
public interface AppModelService {
	...
	/**
	 * 根据配件id获取适用机型信息
	 * @Title:gainAppModelByAccId
	 * @Description:TODO(这里用一句话描述这个方法的作用)
	 * @param @param accId
	 * @param @return 设定文件
	 * @return List<AppModel> 返回类型
	 * @throws
	 * @param accId
	 * @return
	 */
	...
	/**
	 * 根据配件id删除相应适用机型信息
	 * @Title:dropAppModelByAccId
	 * @Description:TODO(这里用一句话描述这个方法的作用)
	 * @param @param accId 设定文件
	 * @return void 返回类型
	 * @throws
	 * @param accId
	 */
