...
public interface RegionsPriceMapper {
	/**
	 * 获取所有节点数据
	 * @Title:gainAllRegionsPrice
	 * @Description:TODO(这里用一句话描述这个方法的作用)
	 * @param @return 设定文件
	 * @return List<RegionsPrice> 返回类型
	 * @throws
	 * @return
	 */
	 ...
	 * @param regionsPrice
	 */
	void updateRegionsPriceById(RegionsPrice regionsPrice);
}